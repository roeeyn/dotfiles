return {
    ...
    keys = {
        ...
        { '<leader>cL', '<cmd>lua vim.cmd.tabnew(vim.lsp.get_log_path())<cr>', desc = '[LSP] Open server log' },
        ...
        { '<leader>cr', '<cmd>lua vim.lsp.stop_client(vim.lsp.get_clients()) vim.cmd.edit()<cr>', desc = '[LSP] Restart server(s)' },
        { '<leader>cs', '<cmd>lua vim.lsp.buf.signature_help()<cr>', desc = '[LSP] Signature help' },
        { '<leader>ct', '<cmd>lua vim.lsp.buf.hover()<cr>', desc = '[LSP] Hover Info' },
