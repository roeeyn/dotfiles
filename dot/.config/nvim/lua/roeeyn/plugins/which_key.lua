...
wk.register({
    ...
    h = {
        name = 'Harpoon',
        a = { '<cmd>lua require("roeeyn.plugins.harpoon").add_file()<cr>', 'Add file' },
        f = { '<cmd>lua require("roeeyn.plugins.harpoon").telescope()<cr>', 'Search in marks' },
        j = { '<cmd>lua require("roeeyn.plugins.harpoon").select_file(1)<cr>', 'Go to mark 1' },
        k = { '<cmd>lua require("roeeyn.plugins.harpoon").select_file(2)<cr>', 'Go to mark 2' },
        l = { '<cmd>lua require("roeeyn.plugins.harpoon").select_file(3)<cr>', 'Go to mark 3' },
        [';'] = { '<cmd>lua require("roeeyn.plugins.harpoon").select_file(4)<cr>', 'Go to mark 4' },
        n = { '<cmd>lua require("roeeyn.plugins.harpoon").next()<cr>', 'Go to next mark' },
        p = { '<cmd>lua require("roeeyn.plugins.harpoon").prev()<cr>', 'Go to prev mark' },
        o = { '<cmd>lua require("roeeyn.plugins.harpoon").quick_ui()<cr>', 'Toggle quick menu' },
        x = { '<cmd>lua require("roeeyn.plugins.harpoon").clear_all()<cr>', 'Clear all marks' },
    },
    l = {
        name = 'Line',
        [';'] = { 'Toggle line comment' },
